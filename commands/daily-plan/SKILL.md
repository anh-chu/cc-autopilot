...
3. Read `$CMC_DATA_DIR/workspaces/<id>/brain-dump.json` for items needing triage
4. Read `$CMC_DATA_DIR/workspaces/<id>/goals.json` for upcoming milestone deadlines
