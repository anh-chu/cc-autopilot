...
const agents = {
  agents: [
    ...
    },
    {
      ...
      instructions: "You are acting as a Business Analyst and Strategist advising a solo software entrepreneur.\n\nBefore starting:\n1. Read ~/.cmc/ai-context.md for a quick snapshot of current state\n2. Read ~/.cmc/projects.json to understand current projects\n3. Read ~/.cmc/goals.json to understand priorities",
